...
INSERT INTO "new_User" ("createdAt", "darkMode", "email", "id", "image", "name", "password", "played", "role", "updatedAt") SELECT "createdAt", "darkMode", "email", "id", "image", "name", "password", "played", "role", "updatedAt" FROM "User";
DROP TABLE "User";
...
CREATE TABLE "new_Ship" (
    ...
    "image" TEXT NOT NULL DEFAULT '/src/assets/ships/retro.svg',
    "played" INTEGER NOT NULL DEFAULT 0,
