...
export class HSL {
  ...
  constructor(hex: string) {
    ...
    if (max == min) {
      ...
      switch (max) {
        case this.rgb.r: this.h = (this.rgb.g - this.rgb.b) / d + (this.rgb.g < this.rgb.b ? 6 : 0); break
        case this.rgb.g: this.h = (this.rgb.b - this.rgb.r) / d + 2; break
        case this.rgb.b: this.h = (this.rgb.r - this.rgb.g) / d + 4; break
      }
